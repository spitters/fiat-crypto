...
static void bls377_Fp12_frobenius_p3(br_word_t out, br_word_t x, br_word_t gamma1, br_word_t gamma2, br_word_t gamma1_p2, br_word_t gamma2_p2, br_word_t w_frob_c1, br_word_t w_frob_p2_c1);
...
static void bls377_Fp12_frobenius_p3(br_word_t out, br_word_t x, br_word_t gamma1, br_word_t gamma2, br_word_t gamma1_p2, br_word_t gamma2_p2, br_word_t w_frob_c1, br_word_t w_frob_p2_c1) {
  ...
  bls377_Fp6_frobenius_p2(tmp, x, gamma1_p2, gamma2_p2);
  bls377_Fp6_frobenius_p2(tmp+0x120, x+0x120, gamma1_p2, gamma2_p2);
  bls377_Fp6_mul_fp2(tmp+0x120, tmp+0x120, w_frob_p2_c1);
  bls377_Fp6_frobenius(out, tmp, gamma1, gamma2);
  bls377_Fp6_frobenius(out+0x120, tmp+0x120, gamma1, gamma2);
  bls377_Fp6_mul_fp2(out+0x120, out+0x120, w_frob_c1);
}
...
static void bls377_final_exp_hard_dsd(br_word_t out, br_word_t f) {
  br_word_t gamma1, gamma2, w_frob_c1, t1, t2, t3, t0;
