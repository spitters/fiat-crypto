...
static void bn254_sub(br_word_t out0, br_word_t in0, br_word_t in1);
static void bn254_mul(br_word_t out0, br_word_t in0, br_word_t in1);
static void bn254_square(br_word_t out0, br_word_t in0);
static void bn254_select_znz(br_word_t out0, br_word_t in0, br_word_t in1, br_word_t in2);
static void bn254_felem_copy(br_word_t out, br_word_t in);
static void bn254_Fp2_mul_xi(br_word_t out, br_word_t x);
static void bn254_Fp6_felem_copy(br_word_t out, br_word_t x);
static void bn254_Fp6_add(br_word_t out, br_word_t inx, br_word_t iny);
static void bn254_Fp6_sub(br_word_t out, br_word_t inx, br_word_t iny);
static void bn254_Fp6_opp(br_word_t out, br_word_t x);
static void bn254_Fp6_mul(br_word_t out, br_word_t inx, br_word_t iny);
static void bn254_Fp6_square(br_word_t out, br_word_t x);
static void bn254_Fp6_inv(br_word_t out, br_word_t x);
static void bn254_Fp6_add_nocopy(br_word_t out, br_word_t inx, br_word_t iny);
static void bn254_Fp6_sub_nocopy(br_word_t out, br_word_t inx, br_word_t iny);
static void bn254_Fp6_mul_by_v(br_word_t out, br_word_t x);
static void bn254_Fp12_felem_copy(br_word_t out, br_word_t x);
static void bn254_Fp12_add(br_word_t out, br_word_t inx, br_word_t iny);
static void bn254_Fp12_sub(br_word_t out, br_word_t inx, br_word_t iny);
static void bn254_Fp12_opp(br_word_t out, br_word_t x);
static void bn254_Fp12_conjugate(br_word_t out, br_word_t x);
static void bn254_Fp12_mul(br_word_t out, br_word_t inx, br_word_t iny);
static void bn254_Fp12_square(br_word_t out, br_word_t x);
static void bn254_Fp12_inv(br_word_t out, br_word_t x);
static void bn254_Fp12_add_nocopy(br_word_t out, br_word_t inx, br_word_t iny);
static void bn254_Fp12_sub_nocopy(br_word_t out, br_word_t inx, br_word_t iny);
static void bn254_Fp12_mul_nocopy(br_word_t out, br_word_t inx, br_word_t iny);
static void bn254_Fp2_conjugate(br_word_t out, br_word_t x);
static void bn254_Fp6_mul_fp2(br_word_t out, br_word_t x, br_word_t s);
static void bn254_Fp6_frobenius(br_word_t out, br_word_t x, br_word_t gamma1, br_word_t gamma2);
static void bn254_Fp6_frobenius_p2(br_word_t out, br_word_t x, br_word_t gamma1_p2, br_word_t gamma2_p2);
static void bn254_Fp12_frobenius(br_word_t out, br_word_t x, br_word_t gamma1, br_word_t gamma2, br_word_t w_frob_c1);
static void bn254_Fp12_frobenius_p2(br_word_t out, br_word_t x, br_word_t gamma1_p2, br_word_t gamma2_p2, br_word_t w_frob_p2_c1);
static void bn254_Fp12_frobenius_p3(br_word_t out, br_word_t x, br_word_t gamma1, br_word_t gamma2, br_word_t gamma1_p2, br_word_t gamma2_p2, br_word_t w_frob_c1, br_word_t w_frob_p2_c1);
static void bn254_Fp2_mul_fp(br_word_t out, br_word_t x, br_word_t s);
static void bn254_make_line(br_word_t out, br_word_t lam, br_word_t x_t, br_word_t y_t, br_word_t x_p, br_word_t y_p);
static void bn254_load_gamma1_p2(br_word_t out);
static void bn254_load_gamma2_p2(br_word_t out);
static void bn254_load_w_frob_p2_c1(br_word_t out);
static void bn254_load_gamma1(br_word_t out);
static void bn254_load_gamma2(br_word_t out);
static void bn254_load_w_frob_c1(br_word_t out);
static void bn254_Fp12_pow_u(br_word_t out, br_word_t base);
static void bn254_final_exp_hard_dsd(br_word_t out, br_word_t f);
static void bn254_final_exp_dsd(br_word_t out, br_word_t f, br_word_t gamma1_p2, br_word_t gamma2_p2, br_word_t w_frob_p2_c1);
static void bn254_miller_loop(br_word_t out, br_word_t p_x, br_word_t p_y, br_word_t q_x, br_word_t q_y);
static void bn254_pairing_dsd(br_word_t out, br_word_t p_x, br_word_t p_y, br_word_t q_x, br_word_t q_y);

void bn254_add(br_word_t out0, br_word_t in0, br_word_t in1) {
  ...
  x16 = x8-0x3c208c16d87cfd47;
  x17 = x10-0x97816a916871ca8d;
  x18 = x17-((br_word_t)(x8<x16));
  x19 = x12-0xb85045b68181585d;
  x20 = x19-(((br_word_t)(x10<x17))+((br_word_t)(x17<x18)));
  x21 = x14-0x30644e72e131a029;
...
static void bn254_sub(br_word_t out0, br_word_t in0, br_word_t in1) {
  ...
  x16 = x8+(x15&0x3c208c16d87cfd47);
  x17 = ((br_word_t)(x16<x8))+x10;
  x18 = x17+(x15&0x97816a916871ca8d);
  x19 = (((br_word_t)(x17<x10))+((br_word_t)(x18<(x15&0x97816a916871ca8d))))+x12;
  x20 = x19+(x15&0xb85045b68181585d);
  x21 = ((((br_word_t)(x19<x12))+((br_word_t)(x20<(x15&0xb85045b68181585d))))+x14)+(x15&0x30644e72e131a029);
  x22 = x16;
  x23 = x18;
  x24 = x20;
  x25 = x21;
...
static void bn254_mul(br_word_t out0, br_word_t in0, br_word_t in1) {
  ...
  x31 = x28+x30;
  x32 = x31+x13;
  x33 = x18*0x87d20782e4866389;
  x34 = x33*0x30644e72e131a029;
  x35 = _br_mulhuu(x33, (br_word_t)0x30644e72e131a029);
  x36 = x33*0xb85045b68181585d;
  x37 = _br_mulhuu(x33, (br_word_t)0xb85045b68181585d);
  x38 = x33*0x97816a916871ca8d;
  x39 = _br_mulhuu(x33, (br_word_t)0x97816a916871ca8d);
  x40 = x33*0x3c208c16d87cfd47;
  x41 = _br_mulhuu(x33, (br_word_t)0x3c208c16d87cfd47);
  x42 = x41+x38;
  ...
  x119 = x116+x118;
  x120 = x98*0x87d20782e4866389;
  x121 = x120*0x30644e72e131a029;
  x122 = _br_mulhuu(x120, (br_word_t)0x30644e72e131a029);
  x123 = x120*0xb85045b68181585d;
  x124 = _br_mulhuu(x120, (br_word_t)0xb85045b68181585d);
  x125 = x120*0x97816a916871ca8d;
  x126 = _br_mulhuu(x120, (br_word_t)0x97816a916871ca8d);
  x127 = x120*0x3c208c16d87cfd47;
  x128 = _br_mulhuu(x120, (br_word_t)0x3c208c16d87cfd47);
  x129 = x128+x125;
  ...
  x207 = x204+x206;
  x208 = x186*0x87d20782e4866389;
  x209 = x208*0x30644e72e131a029;
  x210 = _br_mulhuu(x208, (br_word_t)0x30644e72e131a029);
  x211 = x208*0xb85045b68181585d;
  x212 = _br_mulhuu(x208, (br_word_t)0xb85045b68181585d);
  x213 = x208*0x97816a916871ca8d;
  x214 = _br_mulhuu(x208, (br_word_t)0x97816a916871ca8d);
  x215 = x208*0x3c208c16d87cfd47;
  x216 = _br_mulhuu(x208, (br_word_t)0x3c208c16d87cfd47);
  x217 = x216+x213;
  ...
  x295 = x292+x294;
  x296 = x274*0x87d20782e4866389;
  x297 = x296*0x30644e72e131a029;
  x298 = _br_mulhuu(x296, (br_word_t)0x30644e72e131a029);
  x299 = x296*0xb85045b68181585d;
  x300 = _br_mulhuu(x296, (br_word_t)0xb85045b68181585d);
  x301 = x296*0x97816a916871ca8d;
  x302 = _br_mulhuu(x296, (br_word_t)0x97816a916871ca8d);
  x303 = x296*0x3c208c16d87cfd47;
  x304 = _br_mulhuu(x296, (br_word_t)0x3c208c16d87cfd47);
  x305 = x304+x301;
...
static void bn254_square(br_word_t out0, br_word_t in0) {
  ...
  x27 = x24+x26;
  x28 = x27+x9;
  x29 = x14*0x87d20782e4866389;
  x30 = x29*0x30644e72e131a029;
  x31 = _br_mulhuu(x29, (br_word_t)0x30644e72e131a029);
  x32 = x29*0xb85045b68181585d;
  x33 = _br_mulhuu(x29, (br_word_t)0xb85045b68181585d);
  x34 = x29*0x97816a916871ca8d;
  x35 = _br_mulhuu(x29, (br_word_t)0x97816a916871ca8d);
  x36 = x29*0x3c208c16d87cfd47;
  x37 = _br_mulhuu(x29, (br_word_t)0x3c208c16d87cfd47);
  x38 = x37+x34;
  ...
  x115 = x112+x114;
  x116 = x94*0x87d20782e4866389;
  x117 = x116*0x30644e72e131a029;
  x118 = _br_mulhuu(x116, (br_word_t)0x30644e72e131a029);
  x119 = x116*0xb85045b68181585d;
  x120 = _br_mulhuu(x116, (br_word_t)0xb85045b68181585d);
  x121 = x116*0x97816a916871ca8d;
  x122 = _br_mulhuu(x116, (br_word_t)0x97816a916871ca8d);
  x123 = x116*0x3c208c16d87cfd47;
  x124 = _br_mulhuu(x116, (br_word_t)0x3c208c16d87cfd47);
  x125 = x124+x121;
  ...
  x203 = x200+x202;
  x204 = x182*0x87d20782e4866389;
  x205 = x204*0x30644e72e131a029;
  x206 = _br_mulhuu(x204, (br_word_t)0x30644e72e131a029);
  x207 = x204*0xb85045b68181585d;
  x208 = _br_mulhuu(x204, (br_word_t)0xb85045b68181585d);
  x209 = x204*0x97816a916871ca8d;
  x210 = _br_mulhuu(x204, (br_word_t)0x97816a916871ca8d);
  x211 = x204*0x3c208c16d87cfd47;
  x212 = _br_mulhuu(x204, (br_word_t)0x3c208c16d87cfd47);
  x213 = x212+x209;
  ...
  x291 = x288+x290;
  x292 = x270*0x87d20782e4866389;
  x293 = x292*0x30644e72e131a029;
  x294 = _br_mulhuu(x292, (br_word_t)0x30644e72e131a029);
  x295 = x292*0xb85045b68181585d;
  x296 = _br_mulhuu(x292, (br_word_t)0xb85045b68181585d);
  x297 = x292*0x97816a916871ca8d;
  x298 = _br_mulhuu(x292, (br_word_t)0x97816a916871ca8d);
  x299 = x292*0x3c208c16d87cfd47;
  x300 = _br_mulhuu(x292, (br_word_t)0x3c208c16d87cfd47);
  x301 = x300+x297;
...
static void bn254_Fp2_mul_xi(br_word_t out, br_word_t x) {
  br_word_t tmp_a9, tmp_b9;
  uint8_t _br_stackalloc_tmp_a9[32] = {0}; tmp_a9 = (br_word_t)&_br_stackalloc_tmp_a9;
  uint8_t _br_stackalloc_tmp_b9[32] = {0}; tmp_b9 = (br_word_t)&_br_stackalloc_tmp_b9;
  bn254_add(tmp_a9, x, x);
  bn254_add(tmp_a9, tmp_a9, tmp_a9);
  bn254_add(tmp_a9, tmp_a9, tmp_a9);
  bn254_add(tmp_a9, tmp_a9, x);
  bn254_add(tmp_b9, x+32, x+32);
  bn254_add(tmp_b9, tmp_b9, tmp_b9);
  bn254_add(tmp_b9, tmp_b9, tmp_b9);
  bn254_add(tmp_b9, tmp_b9, x+32);
  bn254_sub(out, tmp_a9, x+32);
  bn254_add(out+32, x, tmp_b9);
}

static void bn254_Fp6_felem_copy(br_word_t out, br_word_t x) {
  bn254_Fp2_felem_copy(out, x);
  bn254_Fp2_felem_copy(out+64, x+64);
  bn254_Fp2_felem_copy(out+128, x+128);
}
...
static void bn254_Fp6_add(br_word_t out, br_word_t inx, br_word_t iny) {
  ...
  bn254_Fp2_add(out+64, allocx+64, allocy+64);
  bn254_Fp2_add(out+128, allocx+128, allocy+128);
}
...
static void bn254_Fp6_sub(br_word_t out, br_word_t inx, br_word_t iny) {
  ...
  bn254_Fp2_sub(out+64, allocx+64, allocy+64);
  bn254_Fp2_sub(out+128, allocx+128, allocy+128);
}
...
static void bn254_Fp6_opp(br_word_t out, br_word_t x) {
  ...
  bn254_Fp2_opp(out+64, allocx+64);
  bn254_Fp2_opp(out+128, allocx+128);
}
...
static void bn254_Fp6_mul(br_word_t out, br_word_t inx, br_word_t iny) {
  ...
  bn254_Fp2_mul(a1b1, allocx+64, allocy+64);
  bn254_Fp2_mul(a2b2, allocx+128, allocy+128);
  bn254_Fp2_add(t, allocx+64, allocx+128);
  bn254_Fp2_add(u, allocy+64, allocy+128);
  bn254_Fp2_mul(t, t, u);
  bn254_Fp2_sub(t, t, a1b1);
  bn254_Fp2_sub(t, t, a2b2);
  bn254_Fp2_mul_xi(t, t);
  bn254_Fp2_add(out, a0b0, t);
  bn254_Fp2_add(t, allocx, allocx+64);
  bn254_Fp2_add(u, allocy, allocy+64);
  bn254_Fp2_mul(t, t, u);
  bn254_Fp2_sub(t, t, a0b0);
  bn254_Fp2_sub(t, t, a1b1);
  bn254_Fp2_mul_xi(u, a2b2);
  bn254_Fp2_add(out+64, t, u);
  bn254_Fp2_add(t, allocx, allocx+128);
  bn254_Fp2_add(u, allocy, allocy+128);
  bn254_Fp2_mul(t, t, u);
  bn254_Fp2_sub(t, t, a0b0);
  bn254_Fp2_sub(t, t, a2b2);
  bn254_Fp2_add(out+128, t, a1b1);
}
...
static void bn254_Fp6_square(br_word_t out, br_word_t x) {
  ...
  bn254_Fp2_mul(t, allocx, allocx+64);
  bn254_Fp2_add(s1, t, t);
  bn254_Fp2_sub(t, allocx, allocx+64);
  bn254_Fp2_add(t, t, allocx+128);
  bn254_Fp2_square(s2, t);
  bn254_Fp2_mul(t, allocx+64, allocx+128);
  bn254_Fp2_add(s3, t, t);
  bn254_Fp2_square(s4, allocx+128);
  bn254_Fp2_mul_xi(t, s3);
  bn254_Fp2_add(out, s0, t);
  bn254_Fp2_mul_xi(t, s4);
  bn254_Fp2_add(out+64, s1, t);
  bn254_Fp2_add(t, s1, s2);
  bn254_Fp2_add(t, t, s3);
  bn254_Fp2_sub(t, t, s0);
  bn254_Fp2_sub(out+128, t, s4);
}
...
static void bn254_Fp6_inv(br_word_t out, br_word_t x) {
  ...
  bn254_Fp2_mul(t2, allocx+64, allocx+128);
  bn254_Fp2_mul_xi(t3, t2);
  bn254_Fp2_sub(vA, t1, t3);
  bn254_Fp2_square(t1, allocx+128);
  bn254_Fp2_mul_xi(t3, t1);
  bn254_Fp2_mul(t2, allocx, allocx+64);
  bn254_Fp2_sub(vB, t3, t2);
  bn254_Fp2_square(t1, allocx+64);
  bn254_Fp2_mul(t2, allocx, allocx+128);
  bn254_Fp2_sub(vC, t1, t2);
  bn254_Fp2_mul(t1, allocx, vA);
  bn254_Fp2_mul(t2, allocx+128, vB);
  bn254_Fp2_mul(t3, allocx+64, vC);
  bn254_Fp2_add(t2, t2, t3);
  bn254_Fp2_mul_xi(t2, t2);
  bn254_Fp2_add(t1, t1, t2);
  bn254_Fp2_inv(t1, t1);
  bn254_Fp2_mul(out, vA, t1);
  bn254_Fp2_mul(out+64, vB, t1);
  bn254_Fp2_mul(out+128, vC, t1);
}

static void bn254_Fp6_add_nocopy(br_word_t out, br_word_t inx, br_word_t iny) {
  bn254_Fp2_add(out, inx, iny);
  bn254_Fp2_add(out+64, inx+64, iny+64);
  bn254_Fp2_add(out+128, inx+128, iny+128);
}

static void bn254_Fp6_sub_nocopy(br_word_t out, br_word_t inx, br_word_t iny) {
  bn254_Fp2_sub(out, inx, iny);
  bn254_Fp2_sub(out+64, inx+64, iny+64);
  bn254_Fp2_sub(out+128, inx+128, iny+128);
}
...
static void bn254_Fp6_mul_by_v(br_word_t out, br_word_t x) {
  ...
  bn254_Fp2_mul_xi(out, tmp+128);
  bn254_Fp2_felem_copy(out+64, tmp);
  bn254_Fp2_felem_copy(out+128, tmp+64);
}

static void bn254_Fp12_felem_copy(br_word_t out, br_word_t x) {
  bn254_Fp6_felem_copy(out, x);
  bn254_Fp6_felem_copy(out+192, x+192);
}
...
static void bn254_Fp12_add(br_word_t out, br_word_t inx, br_word_t iny) {
  ...
  bn254_Fp6_add(out+192, ax+192, ay+192);
}
...
static void bn254_Fp12_sub(br_word_t out, br_word_t inx, br_word_t iny) {
  ...
  bn254_Fp6_sub(out+192, ax+192, ay+192);
}
...
static void bn254_Fp12_opp(br_word_t out, br_word_t x) {
  ...
  bn254_Fp6_opp(out+192, allocx+192);
}
...
static void bn254_Fp12_mul(br_word_t out, br_word_t inx, br_word_t iny) {
  ...
  bn254_Fp6_mul(v1, ax+192, ay+192);
  bn254_Fp6_add(t, ax, ax+192);
  bn254_Fp6_add(u, ay, ay+192);
  bn254_Fp6_mul(t, t, u);
  bn254_Fp6_mul_by_v(u, v1);
  bn254_Fp6_add(out, v0, u);
  bn254_Fp6_sub(t, t, v0);
  bn254_Fp6_sub(out+192, t, v1);
}
...
static void bn254_Fp12_square(br_word_t out, br_word_t x) {
  ...
  bn254_Fp6_square(t1, allocx+192);
  bn254_Fp6_mul(t2, allocx, allocx+192);
  bn254_Fp6_mul_by_v(t1, t1);
  bn254_Fp6_add(out, t0, t1);
  bn254_Fp6_add(out+192, t2, t2);
}
...
static void bn254_Fp12_inv(br_word_t out, br_word_t x) {
  ...
  bn254_Fp6_mul(out+192, allocx+192, t0);
  bn254_Fp6_opp(out+192, out+192);
}

static void bn254_Fp12_add_nocopy(br_word_t out, br_word_t inx, br_word_t iny) {
  bn254_Fp6_add(out, inx, iny);
  bn254_Fp6_add(out+192, inx+192, iny+192);
}

static void bn254_Fp12_sub_nocopy(br_word_t out, br_word_t inx, br_word_t iny) {
  bn254_Fp6_sub(out, inx, iny);
  bn254_Fp6_sub(out+192, inx+192, iny+192);
}
...
static void bn254_Fp12_mul_nocopy(br_word_t out, br_word_t inx, br_word_t iny) {
  ...
  bn254_Fp6_mul(v1, inx+192, iny+192);
  bn254_Fp6_add(t, inx, inx+192);
  bn254_Fp6_add(u, iny, iny+192);
  bn254_Fp6_mul(t, t, u);
  bn254_Fp6_mul_by_v(u, v1);
  bn254_Fp6_add(out, v0, u);
  bn254_Fp6_sub(t, t, v0);
...
static void bn254_Fp6_mul_fp2(br_word_t out, br_word_t x, br_word_t s) {
  ...
  bn254_Fp2_mul(out+64, x+64, s_copy);
  bn254_Fp2_mul(out+128, x+128, s_copy);
}
...
static void bn254_Fp6_frobenius(br_word_t out, br_word_t x, br_word_t gamma1, br_word_t gamma2) {
  ...
  bn254_Fp2_conjugate(tmp+64, x+64);
  bn254_Fp2_conjugate(tmp+128, x+128);
  bn254_Fp2_felem_copy(out, tmp);
  bn254_Fp2_mul(out+64, tmp+64, gamma1);
  bn254_Fp2_mul(out+128, tmp+128, gamma2);
}

static void bn254_Fp6_frobenius_p2(br_word_t out, br_word_t x, br_word_t gamma1_p2, br_word_t gamma2_p2) {
  bn254_Fp2_felem_copy(out, x);
  bn254_Fp2_mul(out+64, x+64, gamma1_p2);
  bn254_Fp2_mul(out+128, x+128, gamma2_p2);
}

static void bn254_Fp12_frobenius(br_word_t out, br_word_t x, br_word_t gamma1, br_word_t gamma2, br_word_t w_frob_c1) {
  bn254_Fp6_frobenius(out, x, gamma1, gamma2);
  bn254_Fp6_frobenius(out+192, x+192, gamma1, gamma2);
  bn254_Fp6_mul_fp2(out+192, out+192, w_frob_c1);
}

static void bn254_Fp12_frobenius_p2(br_word_t out, br_word_t x, br_word_t gamma1_p2, br_word_t gamma2_p2, br_word_t w_frob_p2_c1) {
  bn254_Fp6_frobenius_p2(out, x, gamma1_p2, gamma2_p2);
  bn254_Fp6_frobenius_p2(out+192, x+192, gamma1_p2, gamma2_p2);
  bn254_Fp6_mul_fp2(out+192, out+192, w_frob_p2_c1);
}
...
static void bn254_Fp12_frobenius_p3(br_word_t out, br_word_t x, br_word_t gamma1, br_word_t gamma2, br_word_t gamma1_p2, br_word_t gamma2_p2, br_word_t w_frob_c1, br_word_t w_frob_p2_c1) {
  ...
  bn254_Fp6_frobenius_p2(tmp+192, x+192, gamma1_p2, gamma2_p2);
  bn254_Fp6_mul_fp2(tmp+192, tmp+192, w_frob_p2_c1);
  bn254_Fp6_frobenius(out, tmp, gamma1, gamma2);
  bn254_Fp6_frobenius(out+192, tmp+192, gamma1, gamma2);
  bn254_Fp6_mul_fp2(out+192, out+192, w_frob_c1);
}

static void bn254_Fp2_mul_fp(br_word_t out, br_word_t x, br_word_t s) {
  bn254_mul(out, x, s);
  bn254_mul(out+32, x+32, s);
}
...
static void bn254_make_line(br_word_t out, br_word_t lam, br_word_t x_t, br_word_t y_t, br_word_t x_p, br_word_t y_p) {
  ...
  bn254_Fp2_opp(out+64, tmp);
  bn254_from_word(out+128, (br_word_t)0);
  bn254_from_word((out+128)+32, (br_word_t)0);
  bn254_from_word(out+192, (br_word_t)0);
  bn254_from_word((out+192)+32, (br_word_t)0);
  bn254_felem_copy((out+192)+64, y_p);
  bn254_from_word(((out+192)+64)+32, (br_word_t)0);
  bn254_from_word((out+192)+128, (br_word_t)0);
  bn254_from_word(((out+192)+128)+32, (br_word_t)0);
}

static void bn254_load_gamma1_p2(br_word_t out) {
  _br_store(out, (br_word_t)0x3350c88e13e80b9c);
  _br_store(out+8, (br_word_t)0x7dce557cdb5e56b9);
  _br_store(out+16, (br_word_t)0x6001b4b8b615564a);
  _br_store(out+24, (br_word_t)0x2682e617020217e0);
...
static void bn254_load_gamma2_p2(br_word_t out) {
  _br_store(out, (br_word_t)0x71930c11d782e155);
  _br_store(out+8, (br_word_t)0xa6bb947cffbe3323);
  _br_store(out+16, (br_word_t)0xaa303344d4741444);
  _br_store(out+24, (br_word_t)0x2c3b3f0d26594943);
  _br_store(out+32, (br_word_t)0);
  _br_store(out+40, (br_word_t)0);
  _br_store(out+48, (br_word_t)0);
  _br_store(out+56, (br_word_t)0);
...
static void bn254_load_w_frob_p2_c1(br_word_t out) {
  _br_store(out, (br_word_t)0xca8d800500fa1bf2);
  _br_store(out+8, (br_word_t)0xf0c5d61468b39769);
  _br_store(out+16, (br_word_t)0xe201271ad0d4418);
  _br_store(out+24, (br_word_t)0x4290f65bad856e6);
  _br_store(out+32, (br_word_t)0);
  _br_store(out+40, (br_word_t)0);
  _br_store(out+48, (br_word_t)0);
  _br_store(out+56, (br_word_t)0);
...
static void bn254_load_gamma1(br_word_t out) {
  _br_store(out, (br_word_t)0xb5773b104563ab30);
  _br_store(out+8, (br_word_t)0x347f91c8a9aa6454);
  _br_store(out+16, (br_word_t)0x7a007127242e0991);
  _br_store(out+24, (br_word_t)0x1956bcd8118214ec);
  _br_store(out+32, (br_word_t)0x6e849f1ea0aa4757);
  _br_store(out+40, (br_word_t)0xaa1c7b6d89f89141);
  _br_store(out+48, (br_word_t)0xb6e713cdfae0ca3a);
  _br_store(out+56, (br_word_t)0x26694fbb4e82ebc3);
}

static void bn254_load_gamma2(br_word_t out) {
  _br_store(out, (br_word_t)0x7361d77f843abe92);
  _br_store(out+8, (br_word_t)0xa5bb2bd3273411fb);
  _br_store(out+16, (br_word_t)0x9c941f314b3e2399);
  _br_store(out+24, (br_word_t)0x15df9cddbb9fd3ec);
  _br_store(out+32, (br_word_t)0x5dddfd154bd8c949);
  _br_store(out+40, (br_word_t)0x62cb29a5a4445b60);
  _br_store(out+48, (br_word_t)0x37bc870a0c7dd2b9);
  _br_store(out+56, (br_word_t)0x24830a9d3171f0fd);
}

static void bn254_load_w_frob_c1(br_word_t out) {
  _br_store(out, (br_word_t)0xaf9ba69633144907);
  _br_store(out+8, (br_word_t)0xca6b1d7387afb78a);
  _br_store(out+16, (br_word_t)0x11bded5ef08a2087);
  _br_store(out+24, (br_word_t)0x2f34d751a1f3a7c);
  _br_store(out+32, (br_word_t)0xa222ae234c492d72);
  _br_store(out+40, (br_word_t)0xd00f02a4565de15b);
  _br_store(out+48, (br_word_t)0xdc2ff3a253dfc926);
  _br_store(out+56, (br_word_t)0x10a75716b3899551);
}
...
static void bn254_Fp12_pow_u(br_word_t out, br_word_t base) {
  ...
  while (i) {
    ...
    bit = ((br_word_t)0x44e992b44a6909f1>>(i&(sizeof(br_word_t)*8-1)))&1;
    if (bit) {
...
static void bn254_miller_loop(br_word_t out, br_word_t p_x, br_word_t p_y, br_word_t q_x, br_word_t q_y) {
  ...
  uint8_t _br_stackalloc_u6p2[8] = {0}; u6p2 = (br_word_t)&_br_stackalloc_u6p2;
  bn254_from_word(f, (br_word_t)1);
  bn254_from_word(f+32, (br_word_t)0);
  bn254_from_word(f+64, (br_word_t)0);
  bn254_from_word((f+64)+32, (br_word_t)0);
  bn254_from_word(f+128, (br_word_t)0);
  bn254_from_word((f+128)+32, (br_word_t)0);
  bn254_from_word(f+192, (br_word_t)0);
  bn254_from_word((f+192)+32, (br_word_t)0);
  bn254_from_word((f+192)+64, (br_word_t)0);
  bn254_from_word(((f+192)+64)+32, (br_word_t)0);
  bn254_from_word((f+192)+128, (br_word_t)0);
  bn254_from_word(((f+192)+128)+32, (br_word_t)0);
  bn254_Fp2_felem_copy(t_x, q_x);
  bn254_Fp2_felem_copy(t_y, q_y);
  _br_store(u6p2, (br_word_t)0x9d797039be763ba8);
  i = (br_word_t)64;
  while (i) {
    i = i-1;
    word = _br_load(u6p2);
    bit = (word>>(i&(sizeof(br_word_t)*8-1)))&1;
