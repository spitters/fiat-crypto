(** * BLS12-381 Top-Level Pairing WP Proof
    Standalone WP correctness proof for bls12_pairing from BLS12_Pairing.v,
    plus the top-level bls12_pairing_correct_standalone theorem.
*)
...
Section BLS12_PairingTop.
    ...
    Instance spec_of_bls12_pairing : spec_of "bls12_pairing" :=
      fnspec! "bls12_pairing" (pout p_px p_py p_qx p_qy : word)
    ...
    Lemma bls12_pairing_ok :
      forall functions
        (EnvContains : map.get functions "bls12_pairing" =
          Some (snd bls12_pairing))
        (HLoadG1 : map.get functions "bls12_load_gamma1_p2" =
          Some (snd bls12_load_gamma1_p2))
        (HLoadG2 : map.get functions "bls12_load_gamma2_p2" =
          Some (snd bls12_load_gamma2_p2))
        (HLoadW : map.get functions "bls12_load_w_frob_p2_c1" =
        ...
        (HMillerLoop : forall ptmp ppx ppy pqx pqy
          ...
          Semantics.call functions "bls12_miller_loop" tr m
        ...
        (HFinalExp : forall po pf pg1 pg2 pw
          ...
          Semantics.call functions "bls12_final_exp" tr m
            [po; pf; pg1; pg2; pw]
            (fun tr' m' rets => rets = [] /\ tr = tr' /\
              exists fe_out,
                ...
                (FElem_Fp12 po fe_out ⋆
                 (FElem_Fp12 pf f ⋆
                  (FElem_Fp2 pg1 g1 ⋆
                   (FElem_Fp2 pg2 g2 ⋆
                    (FElem_Fp2 pw w ⋆ R))))) m')),
      spec_of_bls12_pairing functions.
    Proof.
      intros.
      unfold spec_of_bls12_pairing.
      ...
      unfold bls12_pairing. simpl snd. simpl fst.
      cbv match beta.
      ...
      pose proof (@AbstractField.FElem_from_bytes _ bls12_Fp12_params' _ _ _ _
        bls12_Fp12_rep' wordok mapok a_tmp) as Hfb_tmp.
      ...
      pose proof (@AbstractField.FElem_from_bytes _ bls12_Fp2_params' _ _ _ _
        bls12_Fp2_rep' wordok mapok a_g1) as Hfb_g1.
      ...
      pose proof (@AbstractField.FElem_from_bytes _ bls12_Fp2_params' _ _ _ _
        bls12_Fp2_rep' wordok mapok a_g2) as Hfb_g2.
      ...
      pose proof (@AbstractField.FElem_from_bytes _ bls12_Fp2_params' _ _ _ _
        bls12_Fp2_rep' wordok mapok a_w) as Hfb_w.
      ...
      unfold BLS12_Pairing.pairing_full_body, BLS12_Pairing.cmd_seq_list.

      Local Ltac solve_loader_sep :=
        try change BLS12_PairingHelpers.bls12_Fp2_params' with bls12_Fp2_params';
        try change BLS12_PairingHelpers.bls12_Fp2_rep' with bls12_Fp2_rep';
        try change BLS12_PairingHelpers.bls12_Fp12_params' with bls12_Fp12_params';
        try change BLS12_PairingHelpers.bls12_Fp12_rep' with bls12_Fp12_rep';
        try change BLS12_PairingHelpers.bls12_Fp_rep with bls12_Fp_rep;
        try change BLS12_PairingHelpers.bls12_pf_params with bls12_pf_params;
        ecancel_assumption.

      (* === Call 1: bls12_load_gamma1_p2(gamma1_p2) === *)
      repeat straightline.
      eapply Semantics.weaken_call.
      1: {
        eapply BLS12_PairingHelpers.bls12_load_gamma1_p2_ok.
        - exact HLoadG1.
        - solve_loader_sep.
      }
      ...
      (* === Call 2: bls12_load_gamma2_p2(gamma2_p2) === *)
      repeat straightline.
      eapply Semantics.weaken_call.
      1: {
        eapply BLS12_PairingHelpers.bls12_load_gamma2_p2_ok.
        - exact HLoadG2.
        - solve_loader_sep.
      }
      ...
      (* === Call 3: bls12_load_w_frob_p2_c1(w_frob_p2_c1) === *)
      repeat straightline.
      eapply Semantics.weaken_call.
      1: {
        eapply BLS12_PairingHelpers.bls12_load_w_frob_p2_c1_ok.
        - exact HLoadW.
        - solve_loader_sep.
      }
      ...
      (* === Call 4: bls12_miller_loop(tmp, p_x, p_y, q_x, q_y) === *)
      repeat straightline.
      eapply Semantics.weaken_call.
      1: {
      ...
      (* === Call 5: bls12_final_exp(out, tmp, g1, g2, w) === *)
      repeat straightline.
      eapply Semantics.weaken_call.
      1: {
        ...
        try change BLS12_PairingHelpers.bls12_Fp2_params' with bls12_Fp2_params' in *;
        try change BLS12_PairingHelpers.bls12_Fp2_rep' with bls12_Fp2_rep' in *;
        try change BLS12_PairingHelpers.bls12_Fp12_params' with bls12_Fp12_params' in *;
        try change BLS12_PairingHelpers.bls12_Fp12_rep' with bls12_Fp12_rep' in *;
        try change BLS12_PairingHelpers.bls12_Fp_rep with bls12_Fp_rep in *;
        try change BLS12_PairingHelpers.bls12_pf_params with bls12_pf_params in *;
        ecancel_assumption.
      }
      ...
      try change BLS12_PairingHelpers.bls12_Fp2_params' with bls12_Fp2_params' in Hsep_fe;
      try change BLS12_PairingHelpers.bls12_Fp2_rep' with bls12_Fp2_rep' in Hsep_fe;
      try change BLS12_PairingHelpers.bls12_Fp12_params' with bls12_Fp12_params' in Hsep_fe;
      try change BLS12_PairingHelpers.bls12_Fp12_rep' with bls12_Fp12_rep' in Hsep_fe;
      try change BLS12_PairingHelpers.bls12_Fp_rep with bls12_Fp_rep in Hsep_fe;
      try change BLS12_PairingHelpers.bls12_pf_params with bls12_pf_params in Hsep_fe.
    ...
    Theorem bls12_pairing_correct_standalone :
      forall functions tr mem pout p_px p_py p_qx p_qy
        (old_out : Fp12_felem) (p_x p_y : Fp_felem)
        (q_x q_y : Fp2_felem) Rr,
        map.get functions "bls12_pairing" = Some (snd bls12_pairing) ->
        map.get functions "bls12_load_gamma1_p2" =
          Some (snd bls12_load_gamma1_p2) ->
        map.get functions "bls12_load_gamma2_p2" =
          Some (snd bls12_load_gamma2_p2) ->
        map.get functions "bls12_load_w_frob_p2_c1" =
          Some (snd bls12_load_w_frob_p2_c1) ->
        ...
        (forall ptmp ppx ppy pqx pqy
          ...
          Semantics.call functions "bls12_miller_loop" tr0 m0
            [ptmp; ppx; ppy; pqx; pqy]
        ...
        (forall po pf pg1 pg2 pw
          ...
          Semantics.call functions "bls12_final_exp" tr0 m0
            [po; pf; pg1; pg2; pw]
            (fun tr' m' rets => rets = [] /\ tr0 = tr' /\
              exists fe_out,
                Fp12_bounded Fp12_loose fe_out /\
    ...
    Proof.
      intros functions tr mem pout p_px p_py p_qx p_qy
        ...
        Hbqx Hbqy Hbpx Hbpy Hsep.
      (* spec_of_bls12_pairing uses fnspec! with `ensures tr' mem' :=`
      ...
      pose proof (bls12_pairing_ok functions HEnv HLG1 HLG2 HLW HML HFE
