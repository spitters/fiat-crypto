...
Section Field.
  ...
  Instance bls12_field_parameters : FieldParameters.
  Proof using Type.
  ...
  Instance bls12_field_parameters_ok : FieldParameters_ok.
  Proof using Type.
    constructor.
  ...
  Instance bls12_ops : @word_by_word_Montgomery_ops from_mont_string to_mont_string _ _ _ _ _ _ _ _ _ _ (WordByWordMontgomery.n m machine_wordsize) m.
  Proof using Type. Time constructor; make_computed_op. Defined.

  Instance bls12_frep : FieldRepresentation := field_representation m.
  Instance bls12_frep_raw : FieldRepresentation := field_representation_raw m.
  Instance bls12_frep_ok : FieldRepresentation_ok (field_representation:=bls12_frep).
  Proof.
    ...
    Lia.lia.
  Defined.
  Instance bls12_frep_raw_ok : FieldRepresentation_ok (field_representation:=bls12_frep_raw).
  Proof.
    apply Crypto.Bedrock.Field.Synthesis.New.Signature.field_representation_ok.
    intros. assumption.
    let c := eval lazy in felem_size_in_bytes in change felem_size_in_bytes with c.
  ...
  Derive bls12_from_bytes
         SuchThat (forall functions,
                      functions_contain functions bls12_from_bytes ->
                      spec_of_from_bytes
                        (field_representation:=bls12_frep_raw)
                        functions)
  ...
  Derive bls12_to_bytes
         SuchThat (forall functions,
                      functions_contain functions bls12_to_bytes ->
                      spec_of_to_bytes
                        (field_representation:=bls12_frep_raw)
                        functions)
  ...
  Derive bls12_mul
         SuchThat (forall functions,
                      functions_contain functions bls12_mul ->
  ...
  Derive bls12_square
         SuchThat (forall functions,
                      functions_contain functions bls12_square ->
  ...
  Derive bls12_add
         SuchThat (forall functions,
                      functions_contain functions bls12_add ->
  ...
  Derive bls12_sub
         SuchThat (forall functions,
                      functions_contain functions bls12_sub ->
  ...
  Derive bls12_from_mont
         SuchThat (forall functions,
                      functions_contain functions bls12_from_mont ->
  ...
  Derive bls12_to_mont
         SuchThat (forall functions,
                      functions_contain functions bls12_to_mont ->
                      spec_of_UnOp un_to_mont
                        (field_representation:=bls12_frep)
                        functions)
         As bls12_to_mont_correct.
  Proof.
    epair.
  ...
  Derive bls12_select_znz
           SuchThat (forall functions,
                      functions_contain functions bls12_select_znz ->
                      spec_of_selectznz
                        (field_representation:=bls12_frep)
                        functions)
