(** * BN256 DSD Final Exponentiation WP Proof
    Proves bn256_final_exp_dsd (6 calls) satisfies its spec.
...
Section BN256_FinalExpDSD.
    ...
    Instance spec_of_Fp12_inv : spec_of (AbstractField.inv (F:=Fp12)) :=
      AbstractField.unop_spec (F:=Fp12) (field_representation:=bn256_Fp12_rep') AbstractField.un_inv.
    ...
    Instance spec_of_bn256_final_exp_dsd : spec_of "bn256_final_exp_dsd" :=
      fnspec! "bn256_final_exp_dsd"
    ...
    Lemma bn256_final_exp_dsd_ok :
      forall functions
        (EnvContains : map.get functions "bn256_final_exp_dsd" =
          Some (snd BN256_Pairing.bn256_final_exp_dsd))
        ...
        (HFhard : spec_of_bn256_final_exp_hard_dsd functions),
      spec_of_bn256_final_exp_dsd functions.
    Proof.
      intros. unfold spec_of_bn256_final_exp_dsd.
      ...
      unfold BN256_Pairing.bn256_final_exp_dsd. simpl snd. simpl fst. cbv match beta.
      ...
      pose proof (proj1 (@AbstractField.FElem_from_bytes _ bn256_Fp12_params' _ _ _ _
        bn256_Fp12_rep' wordok mapok a_result mSr) HaSr) as [ri Hri].

      (* Stackalloc 2: tmp *)
      straightline. split. { apply Z_mod_mult. }
      intros a_tmp mSt mCt HaSt HmSt.
      pose proof (proj1 (@AbstractField.FElem_from_bytes _ bn256_Fp12_params' _ _ _ _
        bn256_Fp12_rep' wordok mapok a_tmp mSt) HaSt) as [ti Hti].

      unfold BN256_Pairing.final_exp_dsd_body, BN256_Pairing.cmd_seq_list.
