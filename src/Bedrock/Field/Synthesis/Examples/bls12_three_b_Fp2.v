...
Section FromListFp2.
    ...
    Definition bls12_three_b_G2_body : Syntax.func := (["out"], (nil : list string), bedrock_func_body:(
    ...
    Definition bls12_three_b_G2 : function_t := ("bls12_three_b_G2", bls12_three_b_G2_body).
    ...
    Instance spec_of_bls12_three_b_G2 : spec_of ("bls12_three_b_G2") :=
      fun _ => True.
