...
Section FromListFp2.
    ...
    Definition bls12_three_b_G2 : Syntax.func := ("bls12_three_b_G2", (["out"], (nil : list string), bedrock_func_body:(
    ...
    Instance spec_of_bls12_three_b_G2 : spec_of ("bls12_three_b_G2") := spec_of_from_list three_b_Fp2 "bls12_three_b_G2".
    ...
    Lemma felem_copy_ok : program_logic_goal_for_function! bls12_three_b_G2.
    Proof.
        cbv [spec_of_bls12_three_b_G2 Field.spec_of_from_list]. cbv [program_logic_goal_for].
        intros.
        
        cbv [bls12_three_b_G2]. simpl.
        repeat straightline.

      cbv [FElem Bignum.Bignum] in *.
      sepsimpl.

      assert (size : (felem_size_in_words = 12)%nat) by auto.
      rewrite size in *.
      do 13 (destruct x; try discriminate).
      ...
      eassert ((_ ⋆ Rout) m10) by ecancel_assumption.
      destruct H27 as [mq[mr[Hsplit[Hout HRout]]]].
      ...
      sepsimpl.
      {
        Opaque M_pos three_br three_bi three_bi_words three_br_words.
        simpl.
        unfold fst_felem, snd_felem.
        rewrite firstn_app', skipn_app.
        unfold eval_trans.
        rewrite three_bi_mont_mod.
        rewrite three_br_mont_mod.
        reflexivity.
        reflexivity.
        reflexivity.
      }
      simpl.
        ...
        rewrite firstn_app', skipn_app.
        split.
      eapply three_br_mont_valid.
      eapply three_bi_mont_valid.
      reflexivity.
      reflexivity.
      reflexivity.
      (* eassumption. *)
      eassert (three_br_words ++ three_bi_words =
                 [word.of_Z _; word.of_Z _ ;word.of_Z _ ; word.of_Z _ ; word.of_Z _ ; word.of_Z _
                  ; word.of_Z _; word.of_Z _ ;word.of_Z _ ; word.of_Z _ ; word.of_Z _ ; word.of_Z _]).
      { cbv [three_br_words three_br_mont three_bi_words three_bi_mont]. simpl. eauto. }
      rewrite H28.
      subst v v0 v1 v2 v3 v4 v5 v6 v7 v8 v9.
      cbn -[scalar].
      repeat match goal with
             | |- context[ _ +w _ +w _ ] =>
      ...
      cbn -[scalar].
      subst a a0 a1 a2 a3 a4 a5 a6 a7 a8 a9.
