 ...
 *      composing the two theorems, with final_exponentiation kept opaque
 *      to avoid term explosion from the 1268-bit h3 exponent.
 *)
...
Require Import Crypto.Bedrock.Field.Synthesis.Examples.BLS12_Fp12Feval.
...
(* ================================================================ *)
(** ** Part 1: Final exponentiation feval                           *)
(* ================================================================ *)

Section FinalExpFeval.
  Variable p : positive.
...
(* ================================================================ *)
(** ** Part 2: Top-level pairing feval                              *)
(*                                                                   *)
(* CRITICAL: Make final_exponentiation opaque to prevent term        *)
(* explosion from the 1268-bit h3 exponent during f_equal.           *)
(* ================================================================ *)

Local Opaque Pairing.final_exponentiation.
Local Opaque bedrock2_final_exp bedrock2_pow_Z bedrock2_pow_bits_aux.
...
Section PairingFeval.
  ...
  Definition bedrock2_pairing (P : Pairing.G1Affine p) (Q : Pairing.G2Affine p)
    ...
    bedrock2_final_exp p fg1_p2 fg2_p2 w_frob_p2_c1 f.
  ...
  Proof.
    intros P Q Hp Hq.
    unfold bedrock2_pairing, Pairing.pairing, Pairing.miller_loop.
    rewrite Hp, Hq. simpl orb.
    (* final_exponentiation is opaque, so f_equal splits cleanly *)
    rewrite (final_exp_feval_correct p fg1_p2 fg2_p2 w_frob_p2_c1);
      try assumption.
    f_equal.
