...
static void bls12_zero(uintptr_t out0);
static void bls12_one(uintptr_t out0);
static void bls12_select_znz(uintptr_t out0, uintptr_t in0, uintptr_t in1, uintptr_t in2);
static void bls12_felem_copy(uintptr_t out, uintptr_t in);
static void bls12_fp2_add(uintptr_t out, uintptr_t inx, uintptr_t iny);
static void bls12_fp2_sub(uintptr_t out, uintptr_t inx, uintptr_t iny);
static void bls12_fp2_mul(uintptr_t out, uintptr_t inx, uintptr_t iny);
static void bls12_fp2_zero(uintptr_t out);
static void bls12_fp2_one(uintptr_t out);
static void bls12_fp2_select_znz(uintptr_t out, uintptr_t c, uintptr_t inx, uintptr_t iny);
static void bls12_fp2_felem_copy(uintptr_t out, uintptr_t x);
static void store_zero(uintptr_t outx, uintptr_t outy, uintptr_t outz);
static void shift_scalar(uintptr_t c2, uintptr_t scalar);
static void bls12_three_b_G2(uintptr_t out);
static void group_cmov_alt(uintptr_t outx, uintptr_t outy, uintptr_t outz, uintptr_t x1, uintptr_t y1, uintptr_t z1, uintptr_t x2, uintptr_t y2, uintptr_t z2, uintptr_t pc);
static void curve_add(uintptr_t X1, uintptr_t X2, uintptr_t Y1, uintptr_t Y2, uintptr_t Z1, uintptr_t Z2, uintptr_t Xout, uintptr_t Yout, uintptr_t Zout);
static void curve_add_alt(uintptr_t px1, uintptr_t px2, uintptr_t py1, uintptr_t py2, uintptr_t pz1, uintptr_t pz2, uintptr_t outx, uintptr_t outy, uintptr_t outz);
static void loop_body(uintptr_t px, uintptr_t py, uintptr_t pz, uintptr_t outx, uintptr_t outy, uintptr_t outz, uintptr_t pauxx, uintptr_t pauxy, uintptr_t pauxz, uintptr_t pn, uintptr_t pc);
static void scalar_mult(uintptr_t px, uintptr_t py, uintptr_t pz, uintptr_t outx, uintptr_t outy, uintptr_t outz, uintptr_t pn);
...
static void bls12_one(uintptr_t out0) {
  uintptr_t x0, x1, x2, x3, x4, x5;
  /*skip*/
  x0 = (uintptr_t)8505329371266088957ULL;
  x1 = (uintptr_t)17002214543764226050ULL;
  x2 = (uintptr_t)6865905132761471162ULL;
  x3 = (uintptr_t)8632934651105793861ULL;
  x4 = (uintptr_t)6631298214892334189ULL;
  x5 = (uintptr_t)1582556514881692819ULL;
  /*skip*/
  _br2_store((out0)+((uintptr_t)0ULL), x0, sizeof(uintptr_t));
  _br2_store((out0)+((uintptr_t)8ULL), x1, sizeof(uintptr_t));
  _br2_store((out0)+((uintptr_t)16ULL), x2, sizeof(uintptr_t));
...
static void bls12_fp2_zero(uintptr_t out) {
  bls12_zero(out);
  bls12_zero((out)+((uintptr_t)48ULL));
  return;
}
...
static void bls12_fp2_select_znz(uintptr_t out, uintptr_t c, uintptr_t inx, uintptr_t iny) {
  ...
  bls12_felem_copy(allocy, iny);
  bls12_felem_copy((allocy)+((uintptr_t)48ULL), (iny)+((uintptr_t)48ULL));
  bls12_select_znz(out, c, allocx, allocy);
  bls12_select_znz((out)+((uintptr_t)48ULL), c, (allocx)+((uintptr_t)48ULL), (allocy)+((uintptr_t)48ULL));
  }
  }
  return;
}
...
static void bls12_fp2_felem_copy(uintptr_t out, uintptr_t x) {
  uintptr_t allocx;
  { uint8_t _br2_stackalloc_allocx[(uintptr_t)96ULL]; allocx = (uintptr_t)&_br2_stackalloc_allocx;
  bls12_felem_copy(allocx, x);
  bls12_felem_copy((allocx)+((uintptr_t)48ULL), (x)+((uintptr_t)48ULL));
  bls12_felem_copy(out, allocx);
  bls12_felem_copy((out)+((uintptr_t)48ULL), (allocx)+((uintptr_t)48ULL));
  }
  return;
}
...
static void group_cmov_alt(uintptr_t outx, uintptr_t outy, uintptr_t outz, uintptr_t x1, uintptr_t y1, uintptr_t z1, uintptr_t x2, uintptr_t y2, uintptr_t z2, uintptr_t pc) {
  uintptr_t auxx, auxy, auxz;
  { uint8_t _br2_stackalloc_auxx[(uintptr_t)96ULL]; auxx = (uintptr_t)&_br2_stackalloc_auxx;
  { uint8_t _br2_stackalloc_auxy[(uintptr_t)96ULL]; auxy = (uintptr_t)&_br2_stackalloc_auxy;
  { uint8_t _br2_stackalloc_auxz[(uintptr_t)96ULL]; auxz = (uintptr_t)&_br2_stackalloc_auxz;
  bls12_fp2_select_znz(auxx, _br2_load(pc, sizeof(uintptr_t)), x1, x2);
  bls12_fp2_select_znz(auxy, _br2_load(pc, sizeof(uintptr_t)), y1, y2);
  bls12_fp2_select_znz(auxz, _br2_load(pc, sizeof(uintptr_t)), z1, z2);
  bls12_fp2_felem_copy(outx, auxx);
  bls12_fp2_felem_copy(outy, auxy);
  bls12_fp2_felem_copy(outz, auxz);
  }
  }
  }
  return;
...
static void curve_add(uintptr_t X1, uintptr_t X2, uintptr_t Y1, uintptr_t Y2, uintptr_t Z1, uintptr_t Z2, uintptr_t Xout, uintptr_t Yout, uintptr_t Zout) {
  ...
  bls12_three_b_G2(three_b0);
  { uint8_t _br2_stackalloc_t0[(uintptr_t)96ULL]; t0 = (uintptr_t)&_br2_stackalloc_t0;
  bls12_fp2_mul(t0, X1, X2);
  { uint8_t _br2_stackalloc_t1[(uintptr_t)96ULL]; t1 = (uintptr_t)&_br2_stackalloc_t1;
  bls12_fp2_mul(t1, Y1, Y2);
  { uint8_t _br2_stackalloc_t2[(uintptr_t)96ULL]; t2 = (uintptr_t)&_br2_stackalloc_t2;
  bls12_fp2_mul(t2, Z1, Z2);
  { uint8_t _br2_stackalloc_t3[(uintptr_t)96ULL]; t3 = (uintptr_t)&_br2_stackalloc_t3;
  bls12_fp2_add(t3, X1, Y1);
  { uint8_t _br2_stackalloc_t4[(uintptr_t)96ULL]; t4 = (uintptr_t)&_br2_stackalloc_t4;
  bls12_fp2_add(t4, X2, Y2);
  bls12_fp2_mul(t3, t3, t4);
  bls12_fp2_add(t4, t0, t1);
  bls12_fp2_sub(t3, t3, t4);
  bls12_fp2_add(t4, X1, Z1);
  { uint8_t _br2_stackalloc_t5[(uintptr_t)96ULL]; t5 = (uintptr_t)&_br2_stackalloc_t5;
  bls12_fp2_add(t5, X2, Z2);
  bls12_fp2_mul(t4, t4, t5);
  bls12_fp2_add(t5, t0, t2);
  bls12_fp2_sub(t4, t4, t5);
  bls12_fp2_add(t5, Y1, Z1);
  bls12_fp2_add(Xout, Y2, Z2);
  bls12_fp2_mul(t5, t5, Xout);
  bls12_fp2_add(Xout, t1, t2);
  bls12_fp2_sub(t5, t5, Xout);
  bls12_fp2_mul(Zout, three_b0, t2);
  bls12_fp2_sub(Xout, t1, Zout);
  bls12_fp2_add(Zout, Zout, t1);
  bls12_fp2_mul(Yout, Xout, Zout);
  bls12_fp2_add(t1, t0, t0);
  bls12_fp2_add(t1, t1, t0);
  bls12_fp2_mul(t4, three_b0, t4);
  bls12_fp2_mul(t0, t1, t4);
  bls12_fp2_add(Yout, Yout, t0);
  bls12_fp2_mul(t0, t5, t4);
  bls12_fp2_mul(Xout, t3, Xout);
  bls12_fp2_sub(Xout, Xout, t0);
  bls12_fp2_mul(t0, t3, t1);
  bls12_fp2_mul(Zout, t5, Zout);
  bls12_fp2_add(Zout, Zout, t0);
  }
  }
  }
  }
...
static void curve_add_alt(uintptr_t px1, uintptr_t px2, uintptr_t py1, uintptr_t py2, uintptr_t pz1, uintptr_t pz2, uintptr_t outx, uintptr_t outy, uintptr_t outz) {
  uintptr_t px1a, px2a, py1a, py2a, pz1a, pz2a;
  { uint8_t _br2_stackalloc_px1a[(uintptr_t)96ULL]; px1a = (uintptr_t)&_br2_stackalloc_px1a;
  { uint8_t _br2_stackalloc_py1a[(uintptr_t)96ULL]; py1a = (uintptr_t)&_br2_stackalloc_py1a;
  { uint8_t _br2_stackalloc_pz1a[(uintptr_t)96ULL]; pz1a = (uintptr_t)&_br2_stackalloc_pz1a;
  { uint8_t _br2_stackalloc_px2a[(uintptr_t)96ULL]; px2a = (uintptr_t)&_br2_stackalloc_px2a;
  { uint8_t _br2_stackalloc_py2a[(uintptr_t)96ULL]; py2a = (uintptr_t)&_br2_stackalloc_py2a;
  { uint8_t _br2_stackalloc_pz2a[(uintptr_t)96ULL]; pz2a = (uintptr_t)&_br2_stackalloc_pz2a;
  bls12_fp2_felem_copy(px1a, px1);
  bls12_fp2_felem_copy(px2a, px2);
  bls12_fp2_felem_copy(py1a, py1);
  bls12_fp2_felem_copy(py2a, py2);
  bls12_fp2_felem_copy(pz1a, pz1);
  bls12_fp2_felem_copy(pz2a, pz2);
  curve_add(px1a, px2a, py1a, py2a, pz1a, pz2a, outx, outy, outz);
  }
  }
  }
  }
...
static void loop_body(uintptr_t px, uintptr_t py, uintptr_t pz, uintptr_t outx, uintptr_t outy, uintptr_t outz, uintptr_t pauxx, uintptr_t pauxy, uintptr_t pauxz, uintptr_t pn, uintptr_t pc) {
  store_zero(pauxx, pauxy, pauxz);
  shift_scalar(pc, pn);
  group_cmov_alt(pauxx, pauxy, pauxz, pauxx, pauxy, pauxz, px, py, pz, pc);
  curve_add_alt(outx, pauxx, outy, pauxy, outz, pauxz, outx, outy, outz);
  curve_add_alt(px, px, py, py, pz, pz, px, py, pz);
  return;
}

static void scalar_mult(uintptr_t px, uintptr_t py, uintptr_t pz, uintptr_t outx, uintptr_t outy, uintptr_t outz, uintptr_t pn) {
  uintptr_t iter, pauxx, pauxy, pauxz, cond;
  { uint8_t _br2_stackalloc_pauxx[(uintptr_t)96ULL]; pauxx = (uintptr_t)&_br2_stackalloc_pauxx;
  { uint8_t _br2_stackalloc_pauxy[(uintptr_t)96ULL]; pauxy = (uintptr_t)&_br2_stackalloc_pauxy;
  { uint8_t _br2_stackalloc_pauxz[(uintptr_t)96ULL]; pauxz = (uintptr_t)&_br2_stackalloc_pauxz;
  { uint8_t _br2_stackalloc_cond[(uintptr_t)8ULL]; cond = (uintptr_t)&_br2_stackalloc_cond;
  { uint8_t _br2_stackalloc_iter[(uintptr_t)8ULL]; iter = (uintptr_t)&_br2_stackalloc_iter;
  store_zero(outx, outy, outz);
  _br2_store(iter, (uintptr_t)0ULL, sizeof(uintptr_t));
  while ((uintptr_t)((_br2_load(iter, sizeof(uintptr_t)))<((uintptr_t)256ULL))) {
    _br2_store(iter, (_br2_load(iter, sizeof(uintptr_t)))+((uintptr_t)1ULL), sizeof(uintptr_t));
    loop_body(px, py, pz, outx, outy, outz, pauxx, pauxy, pauxz, pn, cond);
  }
  }
  }
  }
