...
static void bls12_three_b(uintptr_t out);
...
static void group_cmov_alt(uintptr_t outx, uintptr_t outy, uintptr_t outz, uintptr_t x1, uintptr_t y1, uintptr_t z1, uintptr_t x2, uintptr_t y2, uintptr_t z2, uintptr_t pc) {
  ...
  { uint8_t _br2_stackalloc_auxx[(uintptr_t)48ULL]; auxx = (uintptr_t)&_br2_stackalloc_auxx;
  { uint8_t _br2_stackalloc_auxy[(uintptr_t)48ULL]; auxy = (uintptr_t)&_br2_stackalloc_auxy;
  { uint8_t _br2_stackalloc_auxz[(uintptr_t)48ULL]; auxz = (uintptr_t)&_br2_stackalloc_auxz;
  bls12_select_znz(auxx, _br2_load(pc, sizeof(uintptr_t)), x1, x2);
  bls12_select_znz(auxy, _br2_load(pc, sizeof(uintptr_t)), y1, y2);
  bls12_select_znz(auxz, _br2_load(pc, sizeof(uintptr_t)), z1, z2);
  bls12_felem_copy(outx, auxx);
  bls12_felem_copy(outy, auxy);
  bls12_felem_copy(outz, auxz);
  }
  }
  }
  return;
...
static void curve_add_alt(uintptr_t px1, uintptr_t px2, uintptr_t py1, uintptr_t py2, uintptr_t pz1, uintptr_t pz2, uintptr_t outx, uintptr_t outy, uintptr_t outz) {
  ...
  { uint8_t _br2_stackalloc_px1a[(uintptr_t)48ULL]; px1a = (uintptr_t)&_br2_stackalloc_px1a;
  { uint8_t _br2_stackalloc_py1a[(uintptr_t)48ULL]; py1a = (uintptr_t)&_br2_stackalloc_py1a;
  { uint8_t _br2_stackalloc_pz1a[(uintptr_t)48ULL]; pz1a = (uintptr_t)&_br2_stackalloc_pz1a;
  { uint8_t _br2_stackalloc_px2a[(uintptr_t)48ULL]; px2a = (uintptr_t)&_br2_stackalloc_px2a;
  { uint8_t _br2_stackalloc_py2a[(uintptr_t)48ULL]; py2a = (uintptr_t)&_br2_stackalloc_py2a;
  { uint8_t _br2_stackalloc_pz2a[(uintptr_t)48ULL]; pz2a = (uintptr_t)&_br2_stackalloc_pz2a;
  bls12_felem_copy(px1a, px1);
  bls12_felem_copy(px2a, px2);
  bls12_felem_copy(py1a, py1);
  bls12_felem_copy(py2a, py2);
  bls12_felem_copy(pz1a, pz1);
  bls12_felem_copy(pz2a, pz2);
...
static void scalar_mult(uintptr_t px, uintptr_t py, uintptr_t pz, uintptr_t outx, uintptr_t outy, uintptr_t outz, uintptr_t pn) {
  ...
  { uint8_t _br2_stackalloc_pauxx[(uintptr_t)48ULL]; pauxx = (uintptr_t)&_br2_stackalloc_pauxx;
  { uint8_t _br2_stackalloc_pauxy[(uintptr_t)48ULL]; pauxy = (uintptr_t)&_br2_stackalloc_pauxy;
  { uint8_t _br2_stackalloc_pauxz[(uintptr_t)48ULL]; pauxz = (uintptr_t)&_br2_stackalloc_pauxz;
