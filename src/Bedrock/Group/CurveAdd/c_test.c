...
static void bls12_from_list(uintptr_t out);
static void ladderstep(uintptr_t X1, uintptr_t X2, uintptr_t Y1, uintptr_t Y2, uintptr_t Z1, uintptr_t Z2, uintptr_t Xout, uintptr_t Yout, uintptr_t Zout);
static void bls12_felem_copy(uintptr_t out, uintptr_t in);
static void store_one_F(uintptr_t out);
static void store_zero_F(uintptr_t out);
static void store_zero_G(uintptr_t outx, uintptr_t outy, uintptr_t outz);
...
static void group_cmov(uintptr_t outx, uintptr_t outy, uintptr_t outz, uintptr_t x1, uintptr_t y1, uintptr_t z1, uintptr_t x2, uintptr_t y2, uintptr_t z2, uintptr_t pc);
...
static void store_one_F(uintptr_t out) {
  _br2_store(out, (uintptr_t)8505329371266088957ULL, sizeof(uintptr_t));
  _br2_store((out)+((uintptr_t)8ULL), (uintptr_t)17002214543764226050ULL, sizeof(uintptr_t));
  _br2_store((out)+((uintptr_t)16ULL), (uintptr_t)6865905132761471162ULL, sizeof(uintptr_t));
  _br2_store((out)+((uintptr_t)24ULL), (uintptr_t)8632934651105793861ULL, sizeof(uintptr_t));
  _br2_store((out)+((uintptr_t)32ULL), (uintptr_t)6631298214892334189ULL, sizeof(uintptr_t));
  _br2_store((out)+((uintptr_t)40ULL), (uintptr_t)1582556514881692819ULL, sizeof(uintptr_t));
  return;
}

static void store_zero_F(uintptr_t out) {
  _br2_store(out, (uintptr_t)8505329371266088957ULL, sizeof(uintptr_t));
  _br2_store((out)+((uintptr_t)8ULL), (uintptr_t)0ULL, sizeof(uintptr_t));
  _br2_store((out)+((uintptr_t)16ULL), (uintptr_t)0ULL, sizeof(uintptr_t));
  _br2_store((out)+((uintptr_t)24ULL), (uintptr_t)0ULL, sizeof(uintptr_t));
  _br2_store((out)+((uintptr_t)32ULL), (uintptr_t)0ULL, sizeof(uintptr_t));
  _br2_store((out)+((uintptr_t)40ULL), (uintptr_t)0ULL, sizeof(uintptr_t));
  return;
}
...
static void group_cmov(uintptr_t outx, uintptr_t outy, uintptr_t outz, uintptr_t x1, uintptr_t y1, uintptr_t z1, uintptr_t x2, uintptr_t y2, uintptr_t z2, uintptr_t pc) {
  bls12_select_znz(outx, _br2_load(pc, sizeof(uintptr_t)), x1, x2);
  bls12_select_znz(outy, _br2_load(pc, sizeof(uintptr_t)), y1, y2);
  bls12_select_znz(outz, _br2_load(pc, sizeof(uintptr_t)), z1, z2);
  return;
}
...
static void loop_body(uintptr_t px, uintptr_t py, uintptr_t pz, uintptr_t outx, uintptr_t outy, uintptr_t outz, uintptr_t pauxx, uintptr_t pauxy, uintptr_t pauxz, uintptr_t pn, uintptr_t pc) {
  ...
  ladderstep(outx, outy, outz, pauxx, pauxy, pauxz, outx, outy, outz);
  ladderstep(px, py, pz, px, py, pz, px, py, pz);
  return;
}
...
static void scalar_mult(uintptr_t px, uintptr_t py, uintptr_t pz, uintptr_t outx, uintptr_t outy, uintptr_t outz, uintptr_t pn) {
  ...
  store_zero_G(outx, outy, outz);
  _br2_store(iter, (uintptr_t)0ULL, sizeof(uintptr_t));
  while ((uintptr_t)((_br2_load(iter, sizeof(uintptr_t)))<((uintptr_t)384ULL))) {
