...
Instance Fp2_names : FieldNames Fp2 := field_names_prefixed Fp2 "bls12_fp2_".
...
Definition bls12_Fp2_add_mod := (c_module (Fp2_add :: nil)).
Eval compute in bls12_Fp2_add_mod.
Definition bls12_Fp2_mul_mod := (c_module (Fp2_mul :: nil)).
Eval compute in bls12_Fp2_mul_mod.
Definition bls12_Fp2_zero_mod := (c_module (Fp2_zero :: nil)).
Eval compute in bls12_Fp2_zero_mod.
Definition bls12_Fp2_one_mod := (c_module (Fp2_one :: nil)).
Eval compute in bls12_Fp2_one_mod.
Definition bls12_Fp2_select_znz_mod := (c_module (Fp2_select_znz :: nil)).
Eval compute in bls12_Fp2_select_znz_mod.
Definition Fp2_felem_copy_mod := (c_module (Fp2_felem_copy :: nil)).
Eval compute in Fp2_felem_copy_mod.

Definition G2_store_zero_mod := (c_module (store_zero_func (F:=Fp2) :: nil)).
Eval compute in G2_store_zero_mod.
...
Definition three_b_func_mod := (c_module (bls12_three_b_G2 :: nil)).
...
Definition curve_add_mod := (c_module (ladderstep_body "bls12_three_b_G2" :: nil)).
