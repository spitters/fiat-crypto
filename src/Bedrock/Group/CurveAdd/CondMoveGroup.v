            ...
            repeat straightline. eexists; split.
                ...
                - repeat straightline. eexists; split; [solve_locals l| ].
                  repeat straightline. eexists. split.
                  {
                      ...
                      assert (Bignum.Bignum 1 pc [c] = scalar pc c) by admit.
                      rewrite <- H5. ecancel_assumption.
                  }
                  repeat straightline. eexists; split; [solve_locals l| ].
                  repeat straightline. eexists; split; [solve_locals l| ].
                  repeat straightline.
        ...
        1: {
                ...
                repeat straightline. eexists. split.
                {
                    destruct (word.unsigned c =? 1).
                        - eapply load_word_of_sep. assert ( scalar pc c = Bignum.Bignum 1 pc [c]) by admit.
                          rewrite H13. ecancel_assumption.
                        - eapply load_word_of_sep. assert ( scalar pc c = Bignum.Bignum 1 pc [c]) by admit.
                          rewrite H13. ecancel_assumption.
                }
                repeat straightline. eexists. split; [solve_locals l| ].
